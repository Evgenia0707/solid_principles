package com.company.solid.singleResponsibility.example.bad;
...
public class User {
    ...
    public static boolean authenticate() {//check your info in base(log in)
        boolean flag = false;
    ...
    public static void create(String request) {//bad() to long
